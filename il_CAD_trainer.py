...
if __name__ == '__main__':
    ...
    parser.add_argument("--dis_info_mode", '-d', type = str, default = "state_curvature", choices = ('only_curvature', 'state_curvature', 'only_state', 'only_x_tran', 'gps_xy', 'gps_full'))
    ...
    parser.add_argument("--pretrain_agent", "-p", type = str, default = "null")
