"""The trainer for the multi-head model"""
...
from models.visionSafeAC import VisionNaiveMultihead, VisionNaiveRandomization
...
PRETRAIN_ENCODER3 = 'L_track_barc_pretrain3' # this pretrained encoder uses the domain list of [DOMAIN2, DOMAIN4, DOMAIN8]
PRETRAIN_ENCODER4 = 'L_track_barc_pretrain4' # this pretrained encoder uses the domain list of [DOMAIN2, DOMAIN4, DOMAIN5, DOMAIN6, DOMAIN8]

expert_mp = {
    'pid': PIDWrapper,
    'mpcc-conv': MPCCConvWrapper,
}
from il_NR_trainer import DOMAIN1, DOMAIN2, DOMAIN4, DOMAIN5, DOMAIN6, DOMAIN7, DOMAIN8, DOMAIN9

class IL_Trainer_CARLA_VisionNaiveMultiHeadAC(IL_Trainer_CARLA_VisionSafeAC):

    """the trainer for the most naive architecture of the multi-head model,
    in this model, it is assumed that we have perfect knowledge about the current domain"""
    ...
    def __init__(self, carla_params,
        ...
        @param agent_params:
        """
        self.pretrain_encoder_path = PRETRAIN_ENCODER3
    ...
    def initialize_agent(self, comment, heads_num, **kwargs):
        ...
        self.agent = VisionNaiveMultihead(pretrained_agent = pretrain_agent, heads_num = heads_num, **kwargs)
...
if __name__ == '__main__':
    ...
    trainer_cls = IL_Trainer_CARLA_VisionNaiveMultiHeadAC
